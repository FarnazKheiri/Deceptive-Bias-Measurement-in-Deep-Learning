...
## Research Overview
Our work proposes a new bias measurement metric, the Deceptive Signal ($S$), to address the limitations of existing fairness metrics in medical AI. By systematically isolating site-specific features across multiple architectures (EfficientNet, ResNet, and DenseNet), we quantify the "diagnostic power" of non-morphological features.
